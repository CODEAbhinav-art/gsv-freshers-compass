...
const SeniorWisdom = () => {
  ...
  const handleUpvote = async (postId: string) => {
    if (!userId) {
      toast.info("Sign in to upvote (coming soon). For now, share your own wisdom!");
      return;
    }
      ...
      <main className="section-container py-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <h1 className="text-3xl font-bold text-foreground">Senior Wisdom</h1>
            </div>
            <p className="text-muted-foreground max-w-2xl">
              Real, practical advice from GSV seniors. Lessons learned, mistakes to avoid, and tips that actually help.
            </p>
          </div>
        ...
        <div className="rounded-lg border bg-card p-4 mb-6 space-y-3">
          <div className="relative">
            ...
            <Input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search wisdom…" className="pl-9" />
          </div>
        ...
        {loading ? (
          ...
          <div className="rounded-lg border-2 border-dashed border-border p-12 text-center">
            ...
            <h3 className="font-semibold text-foreground mb-1">No wisdom here yet</h3>
