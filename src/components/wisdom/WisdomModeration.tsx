...
import { Lightbulb, Check, X, Trash2, ShieldAlert } from "lucide-react";
...
export const WisdomModeration = () => {
  ...
  if (allowed === null) {
    return <p className="text-center text-muted-foreground py-8">Checking permissions…</p>;
  }
      ...
      <Card>
        <CardContent className="py-10 text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            {userId
              ? "Your account doesn't have admin or moderator role yet."
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-xl font-semibold">Senior Insights — Moderation</h2>
      </div>
